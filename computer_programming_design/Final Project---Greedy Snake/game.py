...
food_green_pic=pygame.transform.scale(food_green_pic,(10,10))
food_green_pic.convert()

food_orange_pic=pygame.image.load("food_orange.png")
food_orange_pic=pygame.transform.scale(food_orange_pic,(10,10))
food_orange_pic.convert()

food_red_pic=pygame.image.load("food_red.png")
food_red_pic=pygame.transform.scale(food_red_pic,(10,10))
food_red_pic.convert()

food_yellow_pic=pygame.image.load("food_yellow.png")
food_yellow_pic=pygame.transform.scale(food_yellow_pic,(10,10))
...
snake_body_b=[[340,320],[340,320+10],[340,320+10*2]]
...
def draw_combo(self, color, font, size, kind):
    ...
    if self=='a':
        combo_rect.midtop = (frame_size_x/10*9.2,200)
    elif self=='b':
        combo_rect.midtop = (frame_size_x/10*0.8,200)
