...
snake_body_a=[[1020,400],[1020,320+20],[1020,400+20*2]]

#四個食物的位置
food_x_1 = random.randrange(18, ((frame_size_x-180)//20)) * 20
food_y_1 = random.randrange(1, ((frame_size_y-180)//20)) * 20
food_pos1 = [food_x_1, food_y_1]
food_spawn1 = True
food_x_2 = random.randrange(18, ((frame_size_x-180)//20)) * 20
food_y_2 = random.randrange(1, ((frame_size_y-180)//20)) * 20
food_pos2=[food_x_2, food_y_2]
food_spawn2 = True
food_x_3 = random.randrange(18, ((frame_size_x-180)//20)) * 20
food_y_3 = random.randrange(1, ((frame_size_y-180)//20)) * 20
food_pos3=[food_x_3, food_y_3]
food_spawn3 = True
food_x_4 = random.randrange(18, ((frame_size_x-180)//20)) * 20
food_y_4 = random.randrange(1, ((frame_size_y-180)//20)) * 20
...
def draw_status(self,font,size,status,placement):
    ...
    if self=="a":
        status_rect.midtop = (frame_size_x-90,(placement+2)*20)
    elif self=="b":
        status_rect.midtop = (90,(placement+2)*20)
...
#前面設置的計時器。時間到了狀態就變為False，即該項狀態變為沒有。
        ...
        if event.type == combo_trigger_b:
            if combo_timer_control_b>0:
                combo_timer_control_b-=1
...
# Spawning food and tool on the screen
    if not food_spawn1:
        food_x_1 = random.randrange(18, ((frame_size_x-180)//20)) *20
        food_y_1 = random.randrange(1, (frame_size_y//20)) * 20
        food_pos1 = [food_x_1, food_y_1]
    food_spawn1 = True
    if not food_spawn2:
        food_x_2 = random.randrange(18, ((frame_size_x-180)//20)) *20
        food_y_2 = random.randrange(1, (frame_size_y//20)) * 20
        food_pos2 = [food_x_2, food_y_2]
    food_spawn2 = True
    if not food_spawn3:
        food_x_3 = random.randrange(18, ((frame_size_x-180)//20)) * 20
        food_y_3 = random.randrange(1, (frame_size_y//20)) * 20
        food_pos3 = [food_x_3, food_y_3]
    food_spawn3 = True
    if not food_spawn4:
        food_x_4 = random.randrange(18, ((frame_size_x-180)//20)) * 20
        food_y_4 = random.randrange(1, (frame_size_y//20)) * 20
        food_pos4 = [food_x_4, food_y_4]
    food_spawn4 = True
...
# Display
    ...
    # Draw food
    #先畫四個
    game_window.blit(food_orange_pic,(food_pos1[0],food_pos1[1]))
    game_window.blit(food_green_pic,(food_pos2[0],food_pos2[1]))
    game_window.blit(food_yellow_pic,(food_pos3[0],food_pos3[1]))
    game_window.blit(food_red_pic,(food_pos4[0],food_pos4[1]))
    ...
    # 背景 new_background
        ...
        show_combo(combo_color_a, combo_color_b, 'bebasneue', 30, kind_a, kind_b)
        # Refresh game screen
        pygame.display.update()
        # Refresh rate
